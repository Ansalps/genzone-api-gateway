...
type ProductServiceClient interface {
	...
	ListCategories(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ListCategoriesResponse, error)
	ListProducts(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ListProductsResponse, error)
}
...
func (c *productServiceClient) ListCategories(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ListCategoriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *productServiceClient) ListProducts(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*ListProductsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProductServiceServer interface {
	...
	ListCategories(context.Context, *EmptyRequest) (*ListCategoriesResponse, error)
	ListProducts(context.Context, *EmptyRequest) (*ListProductsResponse, error)
...
func (UnimplementedProductServiceServer) ListCategories(context.Context, *EmptyRequest) (*ListCategoriesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListCategories not implemented")
}
func (UnimplementedProductServiceServer) ListProducts(context.Context, *EmptyRequest) (*ListProductsResponse, error) {
...
func _ProductService_ListCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).ListCategories(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProductService_ListProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).ListProducts(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
